                ...
                <div class="col-lg-8 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url('dashboard/pengaduan'); ?>">
                                    Pengaduan Masuk</a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="pl-lg-4">
                        ...
                        <hr class="my-4" />
                        <a href="<?= base_url('dashboard'); ?>" class="btn btn-success float-right">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Tulis Tanggapan</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('dashboard/detail_pengaduan_aksi'); ?>" method="POST">
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        <input type="number" name="id_petugas" class="form-control"
                                            value="<?= $this->session->userdata('id_petugas'); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        <textarea type="text" name="tanggapan" class="form-control"></textarea>
