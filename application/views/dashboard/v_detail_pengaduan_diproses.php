                ...
                <div class="col-lg-8 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url('dashboard/pengaduan_diproses'); ?>">
                                    Pengaduan Diproses</a></li>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('dashboard/detail_pengaduan_aksi_diproses'); ?>" method="POST">
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-4">
                                    <input type="hidden" name="id" value="<?= $t->id_pengaduan; ?>">
                                    <div class="form-group">
                                        <label class="form-control-label">ID Pengaduan</label>
                                    </div>
                                </div>
                            ...
                            <a href="<?= base_url('dashboard/pengaduan_diproses'); ?>"
                                class="btn btn-success float-right">Kembali</a>
                        </div>
                    </form>
                </div>
