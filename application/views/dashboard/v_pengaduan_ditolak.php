                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Pengaduan Ditolak</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header border-0">
                    <h3 class="mb-0">Data Pengaduan Ditolak</h3>
                </div>
                <!-- Light table -->
                    ...
                    <table id="example1" class="table align-items-center table-flush">
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('dashboard/detail_pengaduan_ditolak/') . $dp->id_pengaduan; ?>"
