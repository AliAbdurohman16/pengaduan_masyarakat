                        ...
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <?php
								if ($this->session->userdata('nik')) {
									echo '<li class="breadcrumb-item active" aria-current="page">Pengaduan</li>';
								}else{
									echo '<li class="breadcrumb-item active" aria-current="page">Pengaduan Masuk</li>';
								}
							?>
                        </ol>
                    </nav>
                    ...
                    <table id="example1" class="table align-items-center table-flush">
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('dashboard/detail_pengaduan/') . $dp->id_pengaduan; ?>"
