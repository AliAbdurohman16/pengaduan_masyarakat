            ...
            <div class="row">
                <div class="col-xl-8 order-xl-1">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php foreach($edit_pengaduan as $p) { ?>
                            <form action="<?= base_url('dashboard/update_pengaduan'); ?>" method="POST"
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <input type="text" name="tgl" class="form-control"
                                                    value="<?= date('d-m-Y', strtotime($p->tgl_pengaduan)); ?>"
                                                    readonly>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <textarea type="text" name="laporan"
                                                    class="form-control"><?= $p->isi_laporan; ?></textarea>
                                ...
                                <hr class="my-4" />
                                <button class="btn btn-primary float-left" type="submit">Ubah</button>
