						...
						?>
                            <tr>
                                ...
                                <td><img width="100%" class="img-fluid"
                                        src="<?= base_url('gambar/profil/') . $m->foto; ?>"></td>
                                <td>
                                    <a href="<?= base_url('dashboard/edit_masyarakat/') . $m->nik; ?>"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url('dashboard/hapus_masyarakat/') . $m->nik; ?>" class="btn btn-primary">Ya</a>
                </div>
            </div>
        </div>
    </div>
